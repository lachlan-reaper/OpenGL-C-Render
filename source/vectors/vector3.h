...
inline void set_vec3(vector3* vector, const VECTOR_FLT x, const VECTOR_FLT y, const VECTOR_FLT z)
{
	vector.arr[0] = x;
	vector.arr[1] = y;
	vector.arr[2] = z;
...
inline void translate_vec3(vector3* vector, const VECTOR_FLT delta_x, const VECTOR_FLT delta_y, const VECTOR_FLT delta_z)
{
	vector.arr[0] += delta_x;
	vector.arr[1] += delta_y;
	vector.arr[2] += delta_z;
}
inline void scale_vec3(vector3* vector, const VECTOR_FLT delta_x, const VECTOR_FLT delta_y, const VECTOR_FLT delta_z)
{
	vector.arr[0] *= delta_x;
	vector.arr[1] *= delta_y;
	vector.arr[2] *= delta_z;
...
inline void rotate_vec3_x_axis_deg(vector3* vector, const VECTOR_FLT delta)
{
	rotate_vec3_x_axis_rad(vector, deg_to_rad(delta));
}
inline void rotate_vec3_y_axis_deg(vector3* vector, const VECTOR_FLT delta)
{
	rotate_vec3_y_axis_rad(vector, deg_to_rad(delta));
}
inline void rotate_vec3_z_axis_deg(vector3* vector, const VECTOR_FLT delta)
{
	rotate_vec3_z_axis_rad(vector, deg_to_rad(delta));
}

inline void transform_all_vec3_rad(vector3* vector, 
...
inline void transform_all_vec3_deg(vector3* vector, 
	const VECTOR_FLT scale_delta_x, const VECTOR_FLT scale_delta_y, const VECTOR_FLT scale_delta_z,
	const VECTOR_FLT rotate_delta_x, const VECTOR_FLT rotate_delta_y, const VECTOR_FLT rotate_delta_z,
	const VECTOR_FLT translate_delta_x, const VECTOR_FLT translate_delta_y, const VECTOR_FLT translate_delta_z
) {
	transform_vec3_rad(vector, 
...
inline vector3* copy_vec3(const vector3* base, vector3* copy)
{
...
inline void normalize_vec3(vector3* vector)
{
...
inline VECTOR_FLT dot_vec3(const vector3* first, const vector3* second)
{
...
*/
inline vector3* add_vec3s(const vector3* first, vector3* second)
{
...
/*
	Result stored in second
*/
inline vector3* sub_vec3s(const vector3* first, vector3* second)
{
...
/*
	Result stored in second
*/
inline vector3* cross_vec3_by_vec3(const vector3* first, vector3* second)
{
